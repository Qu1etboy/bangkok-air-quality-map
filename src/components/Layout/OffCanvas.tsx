...
export default function OffCanvas({ stations }: { stations: AQIIndex[] }) {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed left-0 top-0 h-screen w-96 overflow-scroll bg-white">
          <button
          ...
          <div className="mt-10">
            ...
            {stations.map((station) => (
              <div className="flex gap-5 border-b px-3 py-5 text-sm">
